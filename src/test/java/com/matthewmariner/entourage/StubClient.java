 ...
 *
 * <p>Mechanically generated from {@code javap net.runelite.api.Client} and its supertypes,
 ...
 * 322, and so that a method this plugin has never used fails loudly the first
 * time a test reaches it instead of quietly returning {@code null}.
 *
 * <p>{@link FakeClient} is the subclass that answers the ten or so calls the follower core makes.
 *
...
class StubClient implements net.runelite.api.Client
{
	static UnsupportedOperationException unsupported(String method)
	{
		return new UnsupportedOperationException(
			"StubClient does not implement Client." + method + "(..) — this plugin has never needed it");
	}
	...
	@Override public java.lang.String macroExpand(java.lang.String a0) { throw unsupported("macroExpand"); }
