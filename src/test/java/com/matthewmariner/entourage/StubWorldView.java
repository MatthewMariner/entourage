 ...
 *
 * <p>Mechanically generated from {@code javap net.runelite.api.WorldView} and its supertypes,
 ...
 * 27, and so that a method this plugin has never used fails loudly the first
 * time a test reaches it instead of quietly returning {@code null}.
 *
 * <p>{@link FakeWorldView} is the subclass that answers the scene rectangle and the collision maps.
 *
...
class StubWorldView implements net.runelite.api.WorldView
{
	static UnsupportedOperationException unsupported(String method)
	{
		return new UnsupportedOperationException(
			"StubWorldView does not implement WorldView." + method + "(..) — this plugin has never needed it");
	}
